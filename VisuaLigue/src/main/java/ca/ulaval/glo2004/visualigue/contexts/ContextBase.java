...
public abstract class ContextBase {
    ...
    @Inject
    public ContextBase(final SportRepository sportRepository, final PlayerCategoryRepository playerCategoryRepository, final ImageRepository imageRepository, final ObstacleRepository obstacleRepository, final PlayRepository playRepository, final SettingsRepository settingsRepository) {
