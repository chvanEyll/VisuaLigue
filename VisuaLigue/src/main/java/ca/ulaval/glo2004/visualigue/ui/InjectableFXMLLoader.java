...
public class InjectableFXMLLoader {
    ...
    private static FXMLLoader createLoader(String viewName, Object controller, Node root) {
    ...
    public static View loadView(String viewName, Object controller, Node root) {
        FXMLLoader fxmlLoader = createLoader(viewName, controller, root);
        try {
            fxmlLoader.load();
    ...
    public static View loadView(String viewName) {
        return loadView(viewName, null, null);
    }
}
